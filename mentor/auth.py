...
class UNTIBackend(BaseOAuth2):
    name = 'unti'
    ID_KEY = 'unti_id'
    AUTHORIZATION_URL = '{}/oauth2/authorize'.format(settings.SSO_URL)
    ACCESS_TOKEN_URL = '{}/oauth2/access_token'.format(settings.SSO_URL)
    ...
    def user_data(self, access_token, *args, **kwargs):
        ...
        return self.get_json(
            '{}/users/me'.format(settings.SSO_URL),
